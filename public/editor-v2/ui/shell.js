...
const STORAGE_KEY='sanci-editor-shell-v1';
...
setupResizers();
window.sanciEditor={version:7,bus,panels:panelRegistry,features:featureRegistry,on:bus.on,emit,openPanel:s=>setPanel(s,true),closePanel:s=>setPanel(s,false),showLeftTab,resizeDock};
featureRegistry.register('shell-runtime',{version:7,persistence:'localStorage'});
emit('shell:ready',{version:7});
