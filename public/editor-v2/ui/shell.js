...
window.sanciEditor={version:5,bus,panels:panelRegistry,features:featureRegistry,on:bus.on,emit,openPanel:s=>setPanel(s,true),closePanel:s=>setPanel(s,false),showLeftTab};
featureRegistry.register('shell-runtime',{version:5});
emit('shell:ready',{version:5});
