(() => {
  const info = {
    ...
    section:['Szakasz','Az oldal egy nagyobb, önálló tartalmi része.'], container:['Konténer','Tartalom szélességének és elhelyezésének rendezésére.'], row:['Sor','Vízszintes elrendezéshez.'], columns:['Oszlopok','Több tartalmi oszlop létrehozására.'], grid:['Rács','Tartalom szabályos rácsos elrendezésére.'], stack:['Egymásra rendezés','Függőleges elrendezéshez.'], flex:['Rugalmas elrendezés','Flex alapú, rugalmas elemrendezéshez.'], group:['Csoport','Több elem együttes kezelésére.'],
