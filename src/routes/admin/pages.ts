...
export async function adminPagesRoute(request:Request,env:Env):Promise<Response>{
 ...
 if(request.method==='PATCH'){
  ...
  const page=document.pages[id];page.name=nextTitle;page.slug=nextSlug;page.metadata={...((page.metadata&&typeof page.metadata==='object')?page.metadata:{}),title:nextTitle,description:nextDescription};
