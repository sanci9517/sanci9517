...
## 40.14 — Editor v2 smoke/regression: Geometry — 2026-09-21

**Állapot:** [x] PASS — felhasználói visszaigazolással lezárva.

A 40.13 / 4. Geometry tesztpont ellenőrzése megtörtént.

Ellenőrzött:
1. X érték módosítása;
2. Y érték módosítása;
3. szélesség módosítása;
4. magasság módosítása;
5. a módosított értékek ténylegesen változtatják a Canvas geometriáját;
6. újrakijelölés után az értékek megmaradnak.
