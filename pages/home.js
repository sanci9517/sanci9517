...
function renderBlock(block) {
  ...
  return `<article class="card page-block composite-block ${layoutClass}"><div class="card-label">${title}</div><div class="composite-elements">${elements.map(renderElement).join('')}</div></article>`;
}
